...
filename = 'D:/Directory..to..save/sdcdata.csv' # Directory to save the csv file.
...
path = 'D:/Directory..to..save/SDC'         # Destination/path to which all the images will be saved
num = 0 
...
while (True):
    num = num + 1
    imageName = 'Image_No'+ str(num) + '.png'      # Name of the images.
